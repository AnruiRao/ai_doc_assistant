...
- 🟡 **V3 进行中** — 实测驱动的 RAG 优化（20 条 query、3 轮目测优化、RAGAS 评估进行中）
...
- [ ] Phase 2：集成 RAGAS 评估 pipeline，出 baseline 分数
- [ ] Phase 3：针对低分 query 做针对性优化（边评估边迭代）
- [ ] Phase 4（入口）：证据落地到 docs/decisions/ 和 test-queries.md
